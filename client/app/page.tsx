...
const Homepage = () => {
  ...
  // Filter and sort questions based on selected filter
          ...
          <div className="flex-col max-pc:w-full pc:w-2/3">
            <div className="mb-2">
              <div className="flex justify-between items-center">
                ...
                <button
                  onClick={() => router.push('/ideas/newidea')}
                  className="btn btn-sm"
                >
                  Ask Question
                </button>
              </div>
              <p className="flex items-center text-xs pr-10 mt-2">
                <span onClick={() => setShareQuestion(!shareQuestion)}>
                  <svg
                ...
                Engage in threaded, public discussions on technical topics with Peer-to-Peer, your go-to platform for collaborative learning and knowledge sharing.
              </p>
              <ShareQuestions
            ...
            <div className="flex items-end justify-between mb-4">
              <p className="pc:text-lg max-pc:text-base">
                {filteredQuestions ? filteredQuestions.length : 0} Questions
              </p>
            ...
            {filteredQuestions &&
              filteredQuestions.map((question) => (
                <QuestionCard
                  ...
                  createdAt={formatDistanceToNow(new Date(question.createdAt), {
                    addSuffix: true,
                  })}
                />
              ))}
          ...
          <div className="max-pc:w-full pc:w-[32%]">
            <div className="border-b border-b-gray-600 border-opacity-40 pb-7">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                <div className="tag px-4 rounded-sm font-medium bg-secondary text-base-300">
                  BACKEND
                </div>
                <div className="tag px-4 rounded-sm font-medium bg-secondary text-base-300">
                  JAVA
